FROM datosgobar/portal-base:release-0.8.25
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@3498eb22d7f99eea4e7cdf0d88abc71e9de429d7#egg=ckanext-gobar_theme
