...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@d40921a0365d99742a372a452fd6d7cd34c74ba3#egg=ckanext-gobar_theme && \
