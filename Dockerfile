FROM datosgobar/portal-base:release-0.10.15
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@f15292e2a10828c4a9e20afa36ddb83df9f6b879#egg=ckanext-gobar_theme && \
