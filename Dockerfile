...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@465a03f634adc8f660d5b4fa6564a7bba058aaec#egg=ckanext-gobar_theme && \
