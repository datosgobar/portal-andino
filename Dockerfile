...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@1d5966c3d176eb57da30e4814a97b004e6fa7a85#egg=ckanext-gobar_theme && \
