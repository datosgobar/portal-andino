...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@9626eade36ad4458d03d448c6b105f02320e4797#egg=ckanext-gobar_theme
