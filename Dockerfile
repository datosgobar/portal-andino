...
ARG IMAGE_VERSION=release-0.10.25
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@78f2db71ca16c79a339d83cf4403b4ff3fca4eb6#egg=ckanext-gobar_theme && \
