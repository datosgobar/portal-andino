FROM datosgobar/portal-base:release-0.9.0-beta1
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@andino-112-migrar-a-ckan#egg=ckanext-gobar_theme
