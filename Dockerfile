FROM datosgobar/portal-base:release-0.8.13
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@be6e27b3f3d9a14e423215da15a28d9412884182#egg=ckanext-gobar_theme
