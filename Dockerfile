...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@01059edc217687081f8b1dbe6615c88de983e80a#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.8.0#egg=ckanext-seriestiempoarexplorer
