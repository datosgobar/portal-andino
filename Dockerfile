FROM datosgobar/portal-base:release-0.10.18
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@cf6378f31ae9eadf178008ba5941daec2af0abbf#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@1.1.0#egg=ckanext-seriestiempoarexplorer
