FROM datosgobar/portal-base:release-0.10.6
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@575fd4d01524300b4361e9728aa354899e6c7c95#egg=ckanext-gobar_theme && \
