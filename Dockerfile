...
ARG IMAGE_VERSION=release-0.11.2
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@33f974093d69ae55e5362ed0c3e783df73580df1#egg=ckanext-gobar_theme && \
