...
ARG IMAGE_VERSION=release-0.11.1
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@58f28121e0a72772b6223feb9ece455c8db6ba08#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.5.3#egg=ckanext-seriestiempoarexplorer
