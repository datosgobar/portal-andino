...
ARG IMAGE_VERSION=release-0.10.27
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@9f5fd404a13a4dee509dcf73641f8c830137ca4f#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.3.1#egg=ckanext-seriestiempoarexplorer
