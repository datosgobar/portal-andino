...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@7d04e123ce08b2b3189fef9d01d4d805be81fbf1#egg=ckanext-gobar_theme && \
