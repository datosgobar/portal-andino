...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@d36b928aae729a6f33b962eccbbf8d3d79e0b88a#egg=ckanext-gobar_theme && \
