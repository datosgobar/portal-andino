...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@a23f97cc628250be3613527b4885d3a81075052c#egg=ckanext-gobar_theme && \
