...
ARG IMAGE_VERSION=release-0.10.32
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@392e067f201e90015fbe1a443294dfdafeecf1f3#egg=ckanext-gobar_theme && \
