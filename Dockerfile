...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@c691bc3163584e17e36ff27758a941dac73a668d#egg=ckanext-gobar_theme && \
