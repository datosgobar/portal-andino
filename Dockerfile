...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@da6c465db2f8586503b6df8a576e2982c93a4efc#egg=ckanext-gobar_theme && \
