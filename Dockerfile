FROM datosgobar/portal-base:release-0.8.21
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@55f11354acdd8f5b99eca4e327a22d8fce61cdc6#egg=ckanext-gobar_theme
