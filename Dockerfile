...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@60507a4428778b3196ac177030332855ca0a081e#egg=ckanext-gobar_theme && \
