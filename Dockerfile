...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@7229ecfdb939d0f0ca16d97bbe95276584945e15#egg=ckanext-gobar_theme && \
