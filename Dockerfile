...
ARG IMAGE_VERSION=release-0.10.29
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@89154a0bc537106f9cd13a76d3756e7642262995#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.4.5#egg=ckanext-seriestiempoarexplorer
