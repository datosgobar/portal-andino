...
ARG IMAGE_VERSION=release-0.10.21
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@47a3b8e27ac1c0be65d4be95a11cb92e7a91a21d#egg=ckanext-gobar_theme && \
