FROM datosgobar/portal-base:release-0.10.5
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@ed55f7a8e312582ecfacdf56cf8e8510a82e32a3#egg=ckanext-gobar_theme
