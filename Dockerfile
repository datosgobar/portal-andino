...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@abe4954760f3814ae0411b0ebd7c9ee77315ba49#egg=ckanext-gobar_theme && \
