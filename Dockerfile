FROM datosgobar/portal-base:release-0.10.13
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@1dcc3b3f1b4968c07b0ab8a221170d3227c0117b#egg=ckanext-gobar_theme && \
