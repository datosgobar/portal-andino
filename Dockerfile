...
ARG IMAGE_VERSION=release-0.10.31
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@7e6c19c2bbdaeda8fbd4493012457002996943ac#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.4.7-beta1#egg=ckanext-seriestiempoarexplorer
