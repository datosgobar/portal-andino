FROM datosgobar/portal-base:release-0.5
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@translations#egg=ckanext-gobar_theme
