...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@d2f31b572aa7f078d01f53e240fda08e656b2052#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.4.8#egg=ckanext-seriestiempoarexplorer
