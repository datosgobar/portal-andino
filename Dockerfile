...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@49a3e64a18f3a6178a20fcbb17d51ebf083e1cd2#egg=ckanext-gobar_theme && \
