...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@31b2422fe298bcb0d871548a595de4a246433e6c#egg=ckanext-gobar_theme && \
