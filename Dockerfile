FROM datosgobar/portal-base:release-0.8.10
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@8d70ea9c1d71c267e5a414261c064c318172c24d#egg=ckanext-gobar_theme
