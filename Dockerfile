FROM datosgobar/portal-base:release-0.8.12
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@1202c90677138d8445961460eeb1143e5086a63c#egg=ckanext-gobar_theme
