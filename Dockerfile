FROM datosgobar/portal-base:release-0.10.12
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@2d6b28fcb9baa2121425e0e252ca6197510f7b6b#egg=ckanext-gobar_theme && \
