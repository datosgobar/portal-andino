FROM datosgobar/portal-base:release-0.8.22
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@52a94a3bf0541318ad3a4a6a11f204e2a0b4d28a#egg=ckanext-gobar_theme
