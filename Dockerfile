FROM datosgobar/portal-base:release-0.8.23
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@7c3b3b604d8aa6ef89adb31b08e8088aaefe677c#egg=ckanext-gobar_theme
