FROM datosgobar/portal-base:release-0.10.16
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@c19930d2e7ad09a858b3f0dea13b18246c6fb655#egg=ckanext-gobar_theme && \
