FROM datosgobar/portal-base:release-0.8.5
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@4bc2e978031278a366a1c420397a137ac52263c0#egg=ckanext-gobar_theme
