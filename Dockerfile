...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@a3db8f546a3cd1b8516e7047399372880c5052ad#egg=ckanext-gobar_theme && \
