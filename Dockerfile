...
ARG IMAGE_VERSION=release-0.10.22
...
# portal-andino-theme
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@c03159906a1c794dbd54a831bdfcd9e014650993#egg=ckanext-gobar_theme && \
...
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/ckanext-seriestiempoarexplorer.git@2.0.2#egg=ckanext-seriestiempoarexplorer
