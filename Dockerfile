FROM datosgobar/portal-base:release-0.8.17
...
WORKDIR /portal
RUN $CKAN_HOME/bin/pip install -e git+https://github.com/datosgobar/portal-andino-theme.git@0420f419d12bd4ad1af3352b6ac170cb0b25e88d#egg=ckanext-gobar_theme
